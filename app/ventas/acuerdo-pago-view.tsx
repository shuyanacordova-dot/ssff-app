...
export default function AcuerdoPagoView({ acuerdo, onClose }: { acuerdo: AcuerdoPago; onClose: () => void }) {
  return <section className="glass agenda-board" style={{ marginBottom: 18 }}>
    <div className="print-area">
      <Letterhead company={{ nombre: acuerdo.empresa_nombre ?? "REVELIO", direccion: acuerdo.empresa_direccion, telefono: acuerdo.empresa_telefono, email: acuerdo.empresa_email, logo_url: acuerdo.empresa_logo_url }} subtitle={acuerdo.sucursal_nombre ?? undefined} />
