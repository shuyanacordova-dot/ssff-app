  ...
  return <>
    <header className="app-topbar no-print">
      <div className="app-topbar-inner">
        <Link className="app-nav-brand" href="/" aria-label="Ir al inicio"><Image src="/logos/lumos-logo.png" alt="LumOS" width={36} height={36} priority /><span><strong>LumOS</strong><small>Sistema óptico</small></span></Link>
