...
export default function PatientClinicalClient(props: ClinicalData & { autoCreate?: boolean }) {
  ...
  {isConsulting && selected && <ConsultationModal pacienteId={selected.id} optometrists={props.optometrists} defaultOptometristId={props.profile?.rol === "optometra" ? props.profile.id : undefined} onClose={() => setIsConsulting(false)} onSaved={setNotice} />}
