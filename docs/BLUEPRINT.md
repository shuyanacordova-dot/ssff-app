...
3b. **Duplicados de migración pendientes de autorización (2026-09-25)**: 34 ventas "Migración OPTOX - folio N" (folios 5717–5750, Shuvision, 2024–jun 2026, $6,040 de saldo) repiten una venta original vigente del mismo paciente, día y total (ej. Miguel Villaprado 5725 = 3883). Además 5 ventas vigentes de ago–sep (5754, 5758, 5761, 5763, 5765) no tienen su abono ($540) porque quedó en las copias anuladas. Corrección preparada (anular con respaldo + recuperar abonos); el sistema de permisos exige confirmación escrita de Shuyana.
